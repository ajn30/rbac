...
// System settings functionality (dummy data/logic)
...
<body>
    ...
    <div class="dashboard-layout">
        ...
        <div class="main-content">
            <div class="container">
                <h2>Access System Settings</h2>
                <p>Content for accessing system settings will go here.</p>
                <!-- Add form or table for system settings -->
            </div>
        </div>
    </div>
</body>
